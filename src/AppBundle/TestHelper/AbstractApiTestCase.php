...
abstract class AbstractApiTestCase extends KernelTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$staticClient = new Client([ 'http_errors' => false]);
    ...
    protected function createLeague($leaguename ='foo')
    {
        $league = new League();
    ...
    protected function createFootballTeam($teamename ='foo', $stripename ='strip', League $league)
    {
        $footballTeam = new FootballTeam();
        $footballTeam->setStrip($stripename);
        $footballTeam->setName($teamename);
